...
function Totalarrearschart() {
  ...
  return (
    <div>
      ...
      <Text align='center' mt='3rem' weight={700} size='lg' mb='1rem'>Loan Arrears Count over Years</Text>
      <ResponsiveContainer width="100%" height={300}>
        ...
        >
          ...
          <YAxis />
          <Line type="monotone" dataKey="total_loanArrears_accounts" stroke="#8884d8" activeDot={{ r: 5 }} />
        </LineChart>
      </ResponsiveContainer>
    </Container>
